...
import Client.ThreadClientDemande;
import Serveur.Protocole.Logger;
import Serveur.Protocole.Protocole;

import java.io.IOException;
import java.net.*;
public class ThreadServerDemande extends ThreadServer
{
    public ThreadServerDemande(int port, Protocole protocole, Logger logger) throws
            IOException
    {
